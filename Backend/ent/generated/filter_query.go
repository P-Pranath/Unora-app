...
func (_q *FilterQuery) QueryUser() *UserQuery {
...
func (_q *FilterQuery) FirstID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *FilterQuery) FirstIDX(ctx context.Context) string {
...
func (_q *FilterQuery) OnlyID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *FilterQuery) OnlyIDX(ctx context.Context) string {
...
func (_q *FilterQuery) IDs(ctx context.Context) (ids []string, err error) {
...
func (_q *FilterQuery) IDsX(ctx context.Context) []string {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *FilterQuery) WithUser(opts ...func(*UserQuery)) *FilterQuery {
	query := (&UserClient{config: _q.config}).Query()
...
func (_q *FilterQuery) loadUser(ctx context.Context, query *UserQuery, nodes []*Filter, init func(*Filter), assign func(*Filter, *User)) error {
	ids := make([]string, 0, len(nodes))
	nodeids := make(map[string][]*Filter)
	for i := range nodes {
		fk := nodes[i].UserID
...
func (_q *FilterQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(filter.Table, filter.Columns, sqlgraph.NewFieldSpec(filter.FieldID, field.TypeString))
	_spec.From = _q.sql
